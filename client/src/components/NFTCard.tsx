...
export default function NFTCard({
    ...
    async function handleMint(e: MouseEvent<HTMLAnchorElement>) {
        ...
        try {
            // minting in process toast trigger
            // on clicking mint, a toast to inform the user the process have started
            ...
            // if minting is not successful, an error toast will be triggered to inform the user minting is a failure
        }
    }
